...
void loop() {
  ...
  int targetPositions[] = {m0_open, m1_mid, m2_down, 145, m4_mid, m5_left};

  smoothMove(servos, currentPositions, targetPositions, 6, 20);
  ...
  int secondTargetPositions[] = {m0_close, m1_down, m2_up, 172, m4_up, m5_right};

  smoothMove(servos, currentPositions, secondTargetPositions, 6, 20);
